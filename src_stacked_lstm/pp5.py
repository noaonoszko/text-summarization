...
output_file = '/Users/gustavmolander/local/newsroom_data/train_stats_dict_processed_extr_final_5000_.pickle'
    
df = pd.read_pickle('/Users/gustavmolander/local/newsroom_data/train_stats_df_processed_extr_label_5000.pickle')
